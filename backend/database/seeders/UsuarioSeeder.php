...
class UsuarioSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $usuarios = [
            ['user_id' => $adminUserId, 'code' => 'ADMIN', 'nombre' => 'Administrador del Sistema', 'email' => 'admin@lidr.local', 'supervisor' => true],
            ['user_id' => $emp001UserId, 'code' => 'EMP001', 'nombre' => 'Empleado Demo', 'email' => 'empleado@lidr.local', 'supervisor' => false],
        ];
