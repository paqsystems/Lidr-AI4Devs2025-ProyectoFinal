# Endpoint: Crear Asistente/Empleado

## Información General

- **Método:** `POST`
- **Ruta:** `/api/v1/asistentes`
...
Crea un nuevo asistente/empleado. Solo accesible para supervisores.
...
|-------|------|-----------|-------------|--------------|
| `code` | string | Sí | Código único del asistente | No vacío, único (1105, 4101) |
| `nombre` | string | Sí | Nombre completo | No vacío, máximo 200 caracteres |
| `email` | string | No | Email del asistente | Formato válido, único si se proporciona (1108, 4102) |
...
{
  "error": 0,
  "respuesta": "Asistente creado correctamente",
  "resultado": {
    "id": 1,
    "code": "JPEREZ",
    "nombre": "Juan Pérez",
