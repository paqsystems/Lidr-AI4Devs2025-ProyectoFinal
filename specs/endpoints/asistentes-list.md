# Endpoint: Listar Asistentes/Empleados
...
Obtiene una lista paginada de asistentes/empleados. Solo accesible para supervisores.
...
{
  "error": 0,
  "respuesta": "Asistentes obtenidos correctamente",
  "resultado": {
    "items": [
      {
        "id": 1,
