...
El pipeline en `.github/workflows/ci.yml` está configurado para MySQL. Para ejecutar tests en esta rama (MSSQL), se requiere:
- Configurar SQL Server como servicio en el workflow, o
- Ejecutar tests localmente contra SQL Server: `cd backend && php artisan test`
...
| 2026-02-23 | Aplicación de tareas: .env.example, seeders, tests, deploy-ci-cd | Sistema |
